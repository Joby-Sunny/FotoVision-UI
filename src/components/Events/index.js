        ...
        return (
            <div className="events_wrapper">
                <div className="page_wrapper">
                    <div className={this.state.isLoaded ? "page_header" : "page_header loaded"}>
                        <h1>FotoVision Studios</h1>
                    </div>
                    <div className={this.state.isLoaded ? "page_content" : "page_content loaded"}>
